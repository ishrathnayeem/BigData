...
object Main extends App{
  val tripList= Source.fromFile("/Users/ishrathnayeem/MY MAC/Study/Big Data/2. Functions of Big Data/Finalised Project/gtfs_stm/trips.txt").getLines().drop(1)
    .map(line => line.split(","))
    .map(a => Trip(Some(a(0).toInt), Some(a(1)), Some(a(2)), Some(a(3)), Some(a(4)), Some(a(5)), Some(a(6)))).toList
  val routeList = Source.fromFile("/Users/ishrathnayeem/MY MAC/Study/Big Data/2. Functions of Big Data/Finalised Project/gtfs_stm/routes.txt").getLines().drop(1)
    .map(line => line.split(","))
    .map(a => Route(Some(a(0).toInt), Some(a(1)), Some(a(2)), Some(a(3)), Some(a(4)), Some(a(5)), Some(a(6)))).toList
  val calenderList=  Source.fromFile("/Users/ishrathnayeem/MY MAC/Study/Big Data/2. Functions of Big Data/Finalised Project/gtfs_stm/calendar.txt").getLines().drop(1)
    .map(line => line.split(","))
