...
class DataFetchingAndWriting(enrichedList: List[TripandCalender]) {
  val outputFile = new BufferedWriter(new FileWriter("/Users/ishrathnayeem/MY MAC/Study/Big Data/2. Functions of Big Data/Finalised Project/Result/MyBigDataOutput.csv"))
